...
class PaperTwoCircleExample(unittest.TestCase, CommonTests):
    def check_disj_constraint(self, c1, upper, auxVar1, auxVar2):
        ...
        ct.check_linear_coef(self, repn, auxVar1, 1)
        ct.check_linear_coef(self, repn, auxVar2, 1)
    ...
    def check_global_constraint_disj1(self, c1, auxVar, var1, var2):
        ...
        ct.check_linear_coef(self, repn, auxVar, -1)
        ct.check_squared_term_coef(self, repn, var1, 1)
        ct.check_squared_term_coef(self, repn, var2, 1)
        self.assertIsNone(repn.nonlinear)
    ...
    def check_global_constraint_disj2(self, c1, auxVar, var1, var2):
        ...
        self.assertEqual(len(repn.quadratic), 2)
        ct.check_linear_coef(self, repn, var1, -6)
        ct.check_linear_coef(self, repn, var2, -6)
        ct.check_linear_coef(self, repn, auxVar, -1)
        ct.check_squared_term_coef(self, repn, var1, 1)
        ct.check_squared_term_coef(self, repn, var2, 1)
        self.assertIsNone(repn.nonlinear)
    ...
    def test_assume_fixed_vars_permanent(self):
        ...
        ct.check_squared_term_coef(self, repn, m.x[2], 1)
        self.assertIsNone(repn.nonlinear)
        c2 = c[1]
        self.check_global_constraint_disj1(c2, aux_vars1[1], m.x[3], m.x[4])
        ...
        self.assertEqual(len(repn.linear), 2)
        self.assertEqual(len(repn.quadratic), 1)
        ct.check_linear_coef(self, repn, m.x[2], -6)
    ...
    def test_transformation_block_arbitrary_odd_partition(self):
        ...
        ct.check_linear_coef(self, repn, aux_vars1[2], 1)
        ...
        ct.check_linear_coef(self, repn, aux_vars2[2], 1)
        ...
        self.assertEqual(len(repn.quadratic), 1)
        ct.check_linear_coef(self, repn, aux_vars1[2], -1)
        ct.check_squared_term_coef(self, repn, m.x[3], 1)
        self.assertIsNone(repn.nonlinear)
        ...
        self.assertEqual(len(repn.linear), 2)
        self.assertEqual(len(repn.quadratic), 1)
        ct.check_linear_coef(self, repn, m.x[3], -6)
        ct.check_linear_coef(self, repn, aux_vars2[2], -1)
        ct.check_squared_term_coef(self, repn, m.x[3], 1)
    ...
    def check_second_disjunction_global_constraint_disj1(self, c, aux_vars1):
        ...
        self.assertEqual(repn.constant, 0)
        self.assertEqual(len(repn.linear), 2)
        ct.check_linear_coef(self, repn, m.x[1], -2)
        ct.check_linear_coef(self, repn, aux_vars1[0], -1)
        self.assertEqual(len(repn.quadratic), 1)
        ct.check_squared_term_coef(self, repn, m.x[1], 1)
        self.assertIsNone(repn.nonlinear)
    ...
    def check_second_disjunction_global_constraint_disj2(self, c, aux_vars2):
        ...
        self.assertEqual(repn.constant, 0)
        self.assertEqual(len(repn.linear), 2)
        ct.check_linear_coef(self, repn, m.x[1], -4)
        ct.check_linear_coef(self, repn, aux_vars2[0], -1)
        self.assertEqual(len(repn.quadratic), 1)
        ct.check_squared_term_coef(self, repn, m.x[1], 1)
        self.assertIsNone(repn.nonlinear)
...
class NonQuadraticNonlinear(unittest.TestCase, CommonTests):
    def check_transformation_block(self, m, aux1lb, aux1ub, aux2lb, aux2ub):
        ...
        self.assertEqual(len(repn.nonlinear.args[0].args), 2)
        self.assertIsInstance(repn.nonlinear.args[0].args[0], EXPR.PowExpression)
        self.assertIsInstance(repn.nonlinear.args[0].args[1], EXPR.PowExpression)
        self.assertIs(repn.nonlinear.args[0].args[0].args[0], m.x[1])
        self.assertEqual(repn.nonlinear.args[0].args[0].args[1], 4)
        self.assertIs(repn.nonlinear.args[0].args[1].args[0], m.x[2])
        self.assertEqual(repn.nonlinear.args[0].args[1].args[1], 4)
        ...
        self.assertIsInstance(repn.nonlinear.args[0].args[0], EXPR.PowExpression)
        self.assertIsInstance(repn.nonlinear.args[0].args[1], EXPR.PowExpression)
        self.assertIs(repn.nonlinear.args[0].args[0].args[0], m.x[3])
        self.assertEqual(repn.nonlinear.args[0].args[0].args[1], 4)
        self.assertIs(repn.nonlinear.args[0].args[1].args[0], m.x[4])
        self.assertEqual(repn.nonlinear.args[0].args[1].args[1], 4)
        ...
        ct.check_linear_coef(self, sum_repn, m.x[1], -1)
        self.assertEqual(repn.nonlinear.args[0].args[0].args[1], 4)
        self.assertIsInstance(repn.nonlinear.args[0].args[1], EXPR.PowExpression)
        ...
        self.assertIsNone(sum_repn.nonlinear)
        self.assertEqual(len(sum_repn.linear), 1)
        ct.check_linear_coef(self, sum_repn, m.x[2], -1)
        self.assertEqual(repn.nonlinear.args[0].args[1].args[1], 4)
        ...
        self.assertIsNone(sum_repn.nonlinear)
        self.assertEqual(len(sum_repn.linear), 1)
        ct.check_linear_coef(self, sum_repn, m.x[3], -1)
        self.assertEqual(repn.nonlinear.args[0].args[0].args[1], 4)
        self.assertIsInstance(repn.nonlinear.args[0].args[1], EXPR.PowExpression)
        sum_expr = repn.nonlinear.args[0].args[1].args[0]
        self.assertIsInstance(sum_expr, EXPR.SumExpression)
        ...
        self.assertIsNone(sum_repn.nonlinear)
        self.assertEqual(len(sum_repn.linear), 1)
        ct.check_linear_coef(self, sum_repn, m.x[4], -1)
        self.assertEqual(repn.nonlinear.args[0].args[1].args[1], 4)
